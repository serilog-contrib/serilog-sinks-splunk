...
namespace Serilog.Sinks.Splunk
{
    ...
    /// </summary>
    public class SplunkContext : SplunkClient.Context
    {
        /// <summary>
        ...
        /// </summary>
        public SplunkClient.Namespace ResourceNamespace { get;  set; }

        /// <summary>
        /// The transmitter args that represent the source and source type for logging
        /// </summary>
        public SplunkClient.TransmitterArgs TransmitterArgs { get; set; }
        ...
        /// Creates an instance of the SplunkViaHttp context
        /// </summary>
        public SplunkContext(SplunkClient.Scheme scheme, string host, int port, string index, string username, string password, TimeSpan timeout, HttpMessageHandler handler, bool disposeHandler = true) : base(scheme, host, port, timeout, handler, disposeHandler)
        {
            Index = index;
            Username = username;
            Password = password;
